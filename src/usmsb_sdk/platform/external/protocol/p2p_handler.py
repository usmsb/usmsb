...
class P2PProtocolHandler(BaseProtocolHandler):
    """
    ...
    def __init__(
        ...
        """
        Initialize the P2P protocol handler.
        ...
        logger.info(f"P2PProtocolHandler initialized: node_id={self._node_id}")
    ...
    def _register_default_handlers(self) -> None:
        ...
        self._message_handlers["dht_lookup"] = self._handle_dht_lookup
