...
> **注意**: 以下URL为示例URL，实际部署时请替换为你的平台地址

```
Production: https://api.usmsb-sdk.io/v1  (示例)
Development: https://dev-api.usmsb-sdk.io/v1  (示例)
...
> **注意**: 以下为示例流程，实际操作请参考你的平台部署配置

1. Register at USMSB Developer Portal (如已部署)
...
```
wss://api.usmsb-sdk.io/v1/ws  (示例)
本地开发: ws://localhost:8000/v1/ws
```
