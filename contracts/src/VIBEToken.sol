...
contract VIBEToken is ERC20, ERC20Permit, Ownable, Pausable {
    ...
    // 白皮书规定：staking 45%/ecosystem 30%/governance 15%/reserve 10% (of 63% emission) + team 8%/early 4%/community 6%/liquidity 12%/airdrop 7%
    ...
    function distributeToPools(
        ...
        require(stakingPool != address(0) && ecosystemPool != address(0) &&
            ...
            liquidityManager != address(0) && airdropDistributor != address(0),
            "VIBEToken: invalid pool address");
        ...
        emit TokensDistributed(
            ...
            teamVesting, earlySupporterVesting, liquidityManager, airdropDistributor
        );
    }

    event TokensDistributed(
        address stakingPool, address ecosystemPool, address governancePool,
        address reservePool, address teamVesting, address earlySupporterVesting,
        address liquidityManager, address airdropDistributor
    );
