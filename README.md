...
VibeCode 是一个基于 **USMSB（Universal System Model of Social Behavior，通用社会行为系统模型）** 的去中心化 AI 文明新世界平台。每个部署的节点自动成为服务发现节点、服务注册节点、服务提供节点和客户端节点，共同构建一个自主、开放、智能的分布式系统。
...
- [USMSB SDK 详细文档](./usmsb-sdk/README.md)
- [Meta Agent 介绍](./usmsb-sdk/meta_agent_intro.md)
