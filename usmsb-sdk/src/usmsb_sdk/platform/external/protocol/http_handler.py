...
This module provides the handler for HTTP/REST protocol,
enabling communication with external agents via HTTP.
...
class HTTPProtocolHandler(BaseProtocolHandler):
    ...
    This handler implements communication with external agents
    via HTTP/REST API.
