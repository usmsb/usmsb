...
This module implements the MCP protocol adapter for integrating external AI services:
- Standardized interface for Model Context Protocol
- Resource and tool management
- Context management across sessions
- Integration with USMSB Agent communication
