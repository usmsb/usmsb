...
export type ShareLevel = 'public' | 'semi_public' | 'private' | 'hidden'
export type VerificationStatus = 'unverified' | 'pending' | 'verified' | 'failed'
export type ProficiencyLevel = 'basic' | 'intermediate' | 'advanced' | 'expert' | 'master'
export type PatternType = 'problem_solving' | 'optimization' | 'automation' | 'integration' | 'analysis' | 'creative'
...
export interface GeneCapsule {
  ...
  agent_id: string
  version: string
  // Support both naming conventions (backend may return either)
...
export interface GeneCapsuleSummary {
  capsule_id: string
  version: string
  total_tasks: number
  success_rate: number
...
export interface GeneCapsuleResponse {
  success: boolean
  result: GeneCapsule
}

export interface GeneCapsuleSummaryResponse {
  success: boolean
  result: GeneCapsuleSummary
}
